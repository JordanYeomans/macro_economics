...
if __name__ == '__main__':
    ...
    for sec in ['Bills', 'Notes', 'Bonds',
        ...
        axes[0].plot(_data['date'], _data['debt_held_public_amt'], label=sec)
        axes[1].plot(_data['date'], _data['intragov_hold_amt'], label=sec)
        axes[2].plot(_data['date'], _data['total_amt'], label=sec)
